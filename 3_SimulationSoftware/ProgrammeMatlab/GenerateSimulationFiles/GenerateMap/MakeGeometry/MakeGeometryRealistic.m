function[Map] = MakeGeometryRealistic(grid, probe, medium, interface, print_plot, print_hist, simu_dir)
    ...
    for i = 1:Nx
        Map(periInd: to_px(interface.endost), i) = 1;
    end 
...
function [pore_x, pore_z, pore_size] = MakePore(grid, interface)
    ...
    % std = 1/2.35;                               % FWHM/2 = 0.5 mm for the pore distribution and FWHM = 2.35*std 
    std = 1.4/2.35;
