function[Map, heights] = MakeGeometryExVivoSegmented(grid, interface, filter, print, simu_dir)
% MakeGeometryExVivoSegmented generates a map representing the bone/soft tissue interface from segmented endosteum.
%
% Syntax:
%   [Map, heights] = MakeGeometryExVivo(grid, interface, filter, print, simu_dir)
%
% Description:
%   MakeGeometryExVivoSegmented generates a map representing the bone/soft tissue interface based on extraction of the endost of the bone define in waviness.
