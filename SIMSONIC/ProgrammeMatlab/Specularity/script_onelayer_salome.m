...
transmit_sequence ='SA';% evalin('base','transmit_sequence'); 
geometry = 'planar';%lower(evalin('base','geometry'));
...
data_dir = simul_data_dir;%sprintf('%s/PORE_SIZE_%02d',simul_data_dir,pore_size);
