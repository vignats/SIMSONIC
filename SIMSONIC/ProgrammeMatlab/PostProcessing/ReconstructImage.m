function [FULL_DELAYED_MAP_OF_RF_DATA_PIXEL, DAS_IMAGE_dB, SPECULAR_TRANSFORM] = ReconstructImage(simu_dir, recorded, Map, profile, pixel)
    %
    ...
    %
    pixel_size_wl = 1/8; % 1/4 de longueur d'onde
    ...
    pixel_size = pixel_size_wl*BEST_C_LAYER/PROBE_PARAM.FREQ_Transducteur;
    ...
    [Time_T, Time_R] = function_get_time_of_flight_sa(X,Z,BEST_C_LAYER,PROBE_PARAM.XS,PROBE_PARAM.ZS, ...
        PROBE_PARAM.XR,PROBE_PARAM.ZR);
        ...
        for ix=1:NX
            ...
            if all(transmit_time)
                SPECULAR_MODEL=function_get_pix_simplified_tissue_model(xp,zp,...
                    SPECULAR_INTERFACE,BEST_C_LAYER,PROBE_PARAM.XS, ...
